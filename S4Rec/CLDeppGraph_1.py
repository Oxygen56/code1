...
class CLDeppGraph_1(nn.Module):
    ...
    def __init__(self, user_emb, item_emb, rate_emb, num_users, num_items, num_rate_levels, emb_dim=64, eps=0.1):
        super(CLDeppGraph_1, self).__init__()
